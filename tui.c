...
void setup_colors() {
    ...
    init_color(COLOR_FG, (25*1000)/255, (255*1000)/255, (255*1000)/255);

    init_pair(1, COLOR_FG, COLOR_BG);
    init_pair(2, COLOR_FG, COLOR_BG);
    init_pair(3, COLOR_FG, COLOR_BG);
    init_pair(4, COLOR_FG, COLOR_BG);
    init_pair(5, COLOR_FG, COLOR_BG);
}
...
void calculate_layout(int screen_height, int screen_width, WindowLayout layouts[5]) {
    ...
    layouts[0] = (WindowLayout){TOP_HEIGHT, screen_width, 0, 0};
    layouts[1] = (WindowLayout){library_height, LEFT_WIDTH, TOP_HEIGHT, 0};
    layouts[2] = (WindowLayout){playlist_height, LEFT_WIDTH, TOP_HEIGHT + library_height, 0};
    layouts[3] = (WindowLayout){available_height, main_width, TOP_HEIGHT, LEFT_WIDTH};
    layouts[4] = (WindowLayout){BOTTOM_HEIGHT, screen_width, screen_height - BOTTOM_HEIGHT, 0};
}
